import { CourtsTableProps } from '@/types/courts-table';

const tableItems: CourtsTableProps[] = [
  {
    name: '1',
    price: 20.0,
    freeAt: `Jan 13,2023 23:59`,
    status: 'In Use'
  },
  {
    name: '2',
        ...
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-[#F7F9FC] text-left dark:bg-dark-2">
              <th className="min-w-[220px] px-4 py-4 font-medium text-dark dark:text-white xl:pl-7.5">Court</th>
              <th className="min-w-[150px] px-4 py-4 font-medium text-dark dark:text-white">Free At</th>
          ...
          <tbody>
            {tableItems.map((item, index) => (
              <tr key={index}>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 xl:pl-7.5 ${index === tableItems.length - 1 ? 'border-b-0' : 'border-b'}`}
                >
                  <h5 className="text-dark dark:text-white">{item.name}</h5>
                  <p className="mt-[3px] text-body-sm font-medium">${item.price}</p>
                </td>
                <td className={`border-[#eee] px-4 py-4 dark:border-dark-3 ${index === tableItems.length - 1 ? 'border-b-0' : 'border-b'}`}>
                  <p className="text-dark dark:text-white">{item.freeAt}</p>
                </td>
                <td className={`border-[#eee] px-4 py-4 dark:border-dark-3 ${index === tableItems.length - 1 ? 'border-b-0' : 'border-b'}`}>
                  <p
                ...
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 xl:pr-7.5 ${index === tableItems.length - 1 ? 'border-b-0' : 'border-b'}`}
                >
