...
const menuGroups = [
  {
    ...
    menuItems: [
      {
        icon: (
          <svg className="text- fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        label: 'My stores',
        route: '#',
        children: [{ label: 'Golden Goal', route: '/' }]
      },
      {
        icon: (
...
const Sidebar = () => {
  ...
  return (
    <>
      <aside
        className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden border-r border-stroke bg-white dark:border-stroke-dark dark:bg-gray-dark lg:static lg:translate-x-0 -translate-x-full`}
      >
