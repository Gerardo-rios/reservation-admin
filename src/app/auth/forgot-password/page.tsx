...
export const metadata: Metadata = {
  ...
  description: 'This is the Password Recovery Page'
};
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="hidden w-full p-7.5 xl:block xl:w-1/2">
            <div className="custom-gradient-1 overflow-hidden rounded-2xl px-12.5 pt-12.5 dark:!bg-dark-2 dark:bg-none">
              ...
              <p className="mb-3 text-xl font-medium text-dark dark:text-white">Forget your password?</p>

              <h1 className="mb-4 text-2xl font-bold text-dark dark:text-white sm:text-heading-3">Reset Password!</h1>
